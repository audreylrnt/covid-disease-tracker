  ...
  const getData = countryName => {
    countryName && axios.get(`${baseURL}${countryName}?strict=true`).then(response => {
          setData({
            ...
            case: response.data.cases.toLocaleString(),
            active: response.data.active.toLocaleString(),
            recovered: response.data.recovered.toLocaleString(),
            died: response.data.deaths.toLocaleString(),
            img: response.data.countryInfo.flag,
            updatedtime: new Date(response.data.updated).toString()
          })
        }).catch(error => {
